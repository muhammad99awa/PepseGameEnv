...
/**
 * provided class that helps us produce the terrain
 * with noise function
 */
public class NoiseGenerator {
    ...
    /**
     * Noise is responsible to generate pseudo random noise
     * according to the seed given upon constructing the object.
     *
     * @param x the wanted x to receive noise for
     *         (in our case, the x coordinate of the terrain you'd want to create).
     * @param factor describes how large the noise
     *               should be (play with it, but BLOCK_SIZE *7 should be enough).
